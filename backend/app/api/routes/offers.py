...
from api.dependencies.offers import (
...
from models.offer import OfferCreate, OfferPublic, OfferInDB, OfferUpdate
...
@router.post(
    "/", response_model=OfferPublic, name="offers:create-offer", status_code=status.HTTP_201_CREATED,
